var creditsState = {
    create: function() {
        ...
        this.creatorName = game.add.text(game.world.centerX, 230, 'MANAOIS, JAIRA E. and CATANEO, NIELMER V.', {
            fill: '#fff',
            fontSize: 48
        });
        ...
        this.musicCreatorName = game.add.text(game.world.centerX, 430, 'MANAOIS, JAIRA E. and CATANEO, NIELMER V.', {
            fill: '#fff',
            fontSize: 48
        });
        ...
        this.musicCreator = game.add.text(game.world.centerX, 600, 'Instructor', {
            fill: '#424242'
        });
        this.musicCreator.anchor.setTo(0.5, 0.5);
        this.musicCreatorName = game.add.text(game.world.centerX, 630, 'MR. RUFO N. GABRILLO JR.', {
            fill: '#fff',
            fontSize: 48
        });
        this.musicCreatorName.anchor.setTo(0.5, 0.5);
